...
- (void)setMaxConcurrentDownloads:(NSUInteger)maxConcurrentDownloads {
    self.manager.imageDownloader.maxConcurrentDownloads = (NSInteger) maxConcurrentDownloads;
}

- (NSUInteger)maxConcurrentDownloads {
    return (NSUInteger) self.manager.imageDownloader.maxConcurrentDownloads;
}
