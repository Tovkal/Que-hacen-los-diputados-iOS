...
- (void)storeImage:(UIImage *)image recalculateFromImage:(BOOL)recalculate imageData:(NSData *)imageData forKey:(NSString *)key toDisk:(BOOL)toDisk {
    ...
    [self.memCache setObject:image forKey:key cost:(NSUInteger) (image.size.height * image.size.width * image.scale * image.scale)];
...
- (UIImage *)imageFromDiskCacheForKey:(NSString *)key {
    ...
    if (diskImage) {
        ...
        [self.memCache setObject:diskImage forKey:key cost:(NSUInteger) cost];
    }
